This project is a Weather Dashboard built using HTML, CSS, and JavaScript. It provides real-time weather updates and a 5-day forecast for user-searched cities using the OpenWeatherMap API.
